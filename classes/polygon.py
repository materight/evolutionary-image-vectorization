...
PTS_RADIUS = 20 # Maximm distance radius of generatedpojints in first initialization
...
class Polygon:
    def __init__(self, target, n_vertex):
        ...
        pts = randint(pos-10, pos+10, (n_vertex, 2)) # Create 
